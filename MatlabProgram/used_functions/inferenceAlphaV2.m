function [maxAlpha,typet, x] = inferenceAlphaV2(promps,obsTraj,M,s_ref,c,h,nbData, expNoise, inputUsed, typeReco)
...
for i=1:nbTrajType
  ...
  [bestAlpha(i), proba(i), xs{i}] = computeBestAlphaV2(promps{i}, obsTraj, expNoise, inputUsed, M, nbData,s_ref,c,h, typeReco);
end
