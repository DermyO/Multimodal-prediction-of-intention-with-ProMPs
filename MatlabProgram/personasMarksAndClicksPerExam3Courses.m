...
t = loadTrajectoryPersonas6(strcat('Data/Personas/new_version/',name,'/total_clicks_per_date_',name,'.csv'), l_ids, 's_bar', s_bar, 'name', name);
...
drawDistribution(promp{1}, inputName,s_bar, 'col', 'b', 'ymin', [0,0,-50],'ymax', [1500,100,250], 'xmin', [1,1,1], 'xmax', [promp{1}.meanTimes,promp{1}.meanTimes,promp{1}.meanTimes], 'shaded', 'without', 'fig',11);
drawDistribution(promp{2}, inputName,s_bar, 'col', 'g', 'xLabelName', 'date examens', 'ymin', [0,0,-50],'ymax', [1500,100,250], 'xmin', [1,1,1], 'xmax', [promp{2}.meanTimes,promp{2}.meanTimes,promp{2}.meanTimes], 'shaded', 'without', 'fig',11);
drawDistribution(promp{3}, inputName,s_bar, 'col', 'r' ,'xLabelName', 'date examens', 'ymin', [0,0,-50],'ymax', [1500,100,250], 'xmin', [1,1,1], 'xmax', [promp{3}.meanTimes,promp{3}.meanTimes,promp{3}.meanTimes], 'shaded', 'without', 'fig',11);
drawDistribution(promp{4}, inputName,s_bar, 'col', 'k','xLabelName', 'date examens', 'ymin', [0,0,-50],'ymax', [1500,100,250], 'xmin', [1,1,1], 'xmax', [promp{4}.meanTimes,promp{4}.meanTimes,promp{4}.meanTimes], 'shaded', 'without', 'fig',11);

drawDistribution(promp{1}, inputName,s_bar, 'col', 'b', 'ymin', [0,0,-50],'ymax', [1500,100,250], 'xmin', [1,1,1], 'xmax', [promp{1}.meanTimes,promp{1}.meanTimes,promp{1}.meanTimes], 'fig',12);
drawDistribution(promp{2}, inputName,s_bar, 'col', 'g', 'xLabelName', 'date examens', 'ymin', [0,0,-50],'ymax', [1500,100,250], 'xmin', [1,1,1], 'xmax', [promp{2}.meanTimes,promp{2}.meanTimes,promp{2}.meanTimes],   'fig',13);
drawDistribution(promp{3}, inputName,s_bar, 'col', 'r' ,'xLabelName', 'date examens', 'ymin', [0,0,-50],'ymax', [1500,100,250], 'xmin', [1,1,1], 'xmax', [promp{3}.meanTimes,promp{3}.meanTimes,promp{3}.meanTimes],   'fig',14);
drawDistribution(promp{4}, inputName,s_bar, 'col', 'k','xLabelName', 'date examens', 'ymin', [0,0,-50],'ymax', [1500,100,250], 'xmin', [1,1,1], 'xmax', [promp{4}.meanTimes,promp{4}.meanTimes,promp{4}.meanTimes], 'fig',15);
% 
% nbTotTraj= 0;
% nbTotError = 0;
% 
