...
%load trajectories
t{1} = loadTrajectoryPersonas('Data/Personas/distinction.csv', 'distinction', 'refNb', s_bar);
t{2} = loadTrajectoryPersonas('Data/Personas/Pass.csv', 'pass', 'refNb', s_bar);
t{3} = loadTrajectoryPersonas('Data/Personas/withdrawn.csv', 'withdraw', 'refNb', s_bar);
t{4} = loadTrajectoryPersonas('Data/Personas/Fail.csv', 'fail', 'refNb', s_bar);
