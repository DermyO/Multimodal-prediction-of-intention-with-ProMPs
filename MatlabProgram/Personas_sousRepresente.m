...
l_ids = loadIdPerClass(strcat('Data/Personas/new_version/',name,'/GHPrimaire_DISTINCTION_id_',name,'.csv'),strcat('Data/Personas/new_version/',name,'/GHsous_reprsent_PASS_id_',name,'.csv'),strcat('Data/Personas/new_version/',name,'/GHsous_reprsent_WITHDRAWN_id_',name,'.csv'),strcat('Data/Personas/new_version/',name,'/GHsous_reprsent_FAIL_id_',name,'.csv'));
...
t{2} = loadTrajectoryPersonas5(strcat('Data/Personas/new_version/',name,'/GHsous_reprsent_PASS_id_',name,'.csv'), t{2}, nbInput, 'name',name);
t{3} = loadTrajectoryPersonas5(strcat('Data/Personas/new_version/',name,'/GHsous_reprsent_WITHDRAWN_id_',name,'.csv'), t{3}, nbInput, 'name',name);
t{4} = loadTrajectoryPersonas5(strcat('Data/Personas/new_version/',name,'/GHsous_reprsent_FAIL_id_',name,'.csv'), t{4}, nbInput, 'name',name);
...
drawDistribution(promp{1}, inputName,s_bar, 'col', 'b', 'ymin', [0,0,-50],'ymax', [1500,100,250], 'xmin', [1,1,1], 'xmax', [promp{1}.meanTimes,promp{1}.meanTimes,promp{1}.meanTimes], 'fig',12,'personas_14d');
drawDistribution(promp{2}, inputName,s_bar, 'col', 'g', 'xLabelName', 'date examens', 'ymin', [0,0,-50],'ymax', [1500,100,250], 'xmin', [1,1,1], 'xmax', [promp{2}.meanTimes,promp{2}.meanTimes,promp{2}.meanTimes],   'fig',13,'personas_14d');
drawDistribution(promp{3}, inputName,s_bar, 'col', 'r' ,'xLabelName', 'date examens', 'ymin', [0,0,-50],'ymax', [1500,100,250], 'xmin', [1,1,1], 'xmax', [promp{3}.meanTimes,promp{3}.meanTimes,promp{3}.meanTimes],   'fig',14,'personas_14d');
drawDistribution(promp{4}, inputName,s_bar, 'col', 'k','xLabelName', 'date examens', 'ymin', [0,0,-50],'ymax', [1500,100,250], 'xmin', [1,1,1], 'xmax', [promp{4}.meanTimes,promp{4}.meanTimes,promp{4}.meanTimes], 'fig',15,'personas_14d');
